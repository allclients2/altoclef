...
public class Settings implements IFailableConfigFile {
    ...
    /**
     * If true, collect food when were low, so we can regen.
     */
    private boolean autoCollectFoodForRegen = true;
    ...
    public boolean isautoCollectFoodForRegen() {
        return autoCollectFoodForRegen;
    }
